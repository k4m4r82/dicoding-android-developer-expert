package net.coding4ever.roedhi.mystackwidget;
...
public class ImageBannerWidget extends AppWidgetProvider {
    ...
    private static final String TOAST_ACTION = "net.coding4ever.roedhi.mystackwidget.TOAST_ACTION";
    public static final String EXTRA_ITEM = "net.coding4ever.roedhi.mystackwidget.EXTRA_ITEM";
