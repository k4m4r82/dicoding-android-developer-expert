package net.coding4ever.roedhi.moviecataloguelocalstorage.repositories.local;
...
public class TvShowRepository {
    ...
    private final String TABLE_NAME = "tv_show";
    ...
    public void save(List<TvShow> list) {
    ...
    public int setFavorite(TvShow obj) {
    ...
    public List<TvShow> getFavoriteTvShow(String languageId) {
    ...
    private boolean isExist(TvShow obj) {
