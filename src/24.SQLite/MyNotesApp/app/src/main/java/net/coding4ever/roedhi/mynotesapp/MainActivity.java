...
import net.coding4ever.roedhi.mynotesapp.db.NoteHelper;
import net.coding4ever.roedhi.mynotesapp.entity.Note;

import java.lang.ref.WeakReference;
import java.util.ArrayList;

import static net.coding4ever.roedhi.mynotesapp.NoteAddUpdateActivity.REQUEST_UPDATE;
import static net.coding4ever.roedhi.mynotesapp.NoteAddUpdateActivity.RESULT_DELETE;
...
public class MainActivity extends AppCompatActivity
    ...
    public void preExecute() {
        Log.d("MainActivity", "preExecute on fired");
